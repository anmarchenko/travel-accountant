...
categories = {
  "Food" => ["завтрак", "ужин", "обед", "ресторан", "кофе", "завтрак", "перекус", "булочная", "напитки", "магазин", "чай", "вода", "пиво", "коктейль", "коктейли", "бар"],
  "Souvenirs" => ["сувенир", "сувениры", "магнит", "подарок", "подарки", "игрушка", "игрушки"],
